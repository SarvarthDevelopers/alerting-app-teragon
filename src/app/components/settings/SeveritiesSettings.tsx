...
import { Severity, SeverityConfig } from '../../types';

interface SeveritiesSettingsProps {
  onBack: () => void;
  configs: SeverityConfig[];
  onUpdate: (configs: SeverityConfig[]) => void;
}

export function SeveritiesSettings({ onBack, configs, onUpdate }: SeveritiesSettingsProps) {
