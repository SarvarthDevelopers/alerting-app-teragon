...
function Tab1() {
  return (
    <div className="bg-[#f5f5f5] flex-[1_0_0] min-w-px relative rounded-[12px]" data-name="tab">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[16px] py-[8px] relative size-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#838383] text-[16px] text-center whitespace-nowrap">Profile</p>
        </div>
      </div>
    </div>
  );
...
function Tab2() {
  return (
    <div className="bg-[#262626] flex-[1_0_0] min-w-px relative rounded-[12px]" data-name="tab">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[16px] py-[8px] relative size-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">Flatness</p>
        </div>
      </div>
    </div>
  );
