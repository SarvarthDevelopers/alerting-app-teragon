              ...
              >
                ...
                <AnimatePresence>
                  {isSelectionMode && (
                    <motion.button
                      ...
                      className="px-5 h-11 inline-flex items-center rounded-xl text-xs font-black transition-colors border border-border/50 bg-card text-muted-foreground hover:text-foreground hover:border-foreground whitespace-nowrap overflow-hidden"
                    >
                ...
                <button
                  ...
                  className={`px-5 h-11 inline-flex items-center rounded-xl text-xs font-black transition-all ${
                    isSelectionMode
                      ? 'bg-black text-white'
                      : 'border border-border/50 bg-card text-muted-foreground hover:text-foreground hover:border-foreground'
                  }`}
                >
